...
const BetLists = require('./rummybetLists');

const RummyPlayingTablesSchema = new Schema(
    {
...
module.exports = mongoose.model(collectionName, RummyPlayingTablesSchema, collectionName);
