...
module.exports.deductWallet = async (id, deductChips, tType, t, tbInfo, client, seatIndex) => {
    try {
        ...
        logger.info("teen patti userInfo.chips =>", userInfo.chips)
        ...
        commandAcions.sendEventInTable(tbInfo._id.toString(), CONST.TEEN_PATTI_WALLET_UPDATE, {
            // winningChips: upReps.winningChips,
            chips: upReps.chips,
...
module.exports.addWallet = async (id, added_chips, tType, t, tbInfo, client, seatIndex) => {
    try {
        ...
        commandAcions.sendDirectEvent(client, CONST.TEEN_PATTI_WALLET_UPDATE, {
            winningChips: upReps.winningChips,
            chips: upReps.chips,
            totalWallet: totalRemaningAmount,
            msg: t,
