    ...
    try {
        if (requestData.playerId !== '' && requestData.playerId !== null && requestData.playerId !== undefined) {
            ...
            if (requestData.tableId == '') {
                ...
                sendDirectEvent(client.id.toString(), CONST.AV_RECONNECT, response);
                return false;
            }
            ...
            if (tabInfo.gameState === "StartEviator") {
                ...
                sendDirectEvent(client.id.toString(), CONST.AV_RECONNECT, responseRS);
                ...
                sendDirectEvent(client.id.toString(), CONST.AV_RECONNECT, responseRST);
            } else {
                sendDirectEvent(client.id.toString(), CONST.AV_RECONNECT, response);
            }
            return;
            ...
            sendDirectEvent(client.id, CONST.AV_RECONNECT, response, {
                flag: false,
        ...
        logger.error('AV_RECONNECT.js Exception AV_RECONNECT  => ', e);
    }
};
